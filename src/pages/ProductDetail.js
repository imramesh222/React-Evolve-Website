        ...
        <div className="d-md-flex justify-content-evenly">
          ...
          <div className="col-md-6">
            ...
            <div className="d-flex border rounded w-25">
              <button className="btn btn-secondary fw-bold border-0 me-2" onClick={decrement} disabled={quantity <= 1}>
                -
              </button>
              <input
                type="text"
                ...
                readOnly
              />
              <button className="btn btn-secondary fw-bold border-0 me-2" onClick={increment}>
                +
              </button>
            </div>
