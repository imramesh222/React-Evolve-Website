        ...
        <div className='d-flex justify-content-between align-items-center flex-wrap px-5'>
            <a href='/' className='d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none'><h1>MyPasal</h1></a>
              ...
              {/* <form className='col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 ' role='search'>
                <input type='search'  className='form-control-dark mx-2' placeholder='Search...'></input><button type='submit' className='btn btn-outline-light'><i class="bi bi-search"></i></button>
              </form> */}
              <form className='col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3' role='search' aria-label='Search form'>
  <input
    type='search'
